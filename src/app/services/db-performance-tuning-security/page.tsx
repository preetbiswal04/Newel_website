...
export default function DBPerformanceSecurityPage() {
  const offerings = [
    {
      title: "Query & SQL Tuning",
      description: "Identify and optimise slow-running queries, inefficient execution plans, missing indexes, and poorly written SQL — delivering measurable improvements in application response time and batch processing speed.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Index Optimisation",
      description: "Analyse index usage patterns, identify missing and redundant indexes, and implement index strategies that balance query performance with write overhead.",
      icon: <BarChart3 className="w-6 h-6" />,
    },
    {
      title: "Database Configuration Tuning",
      description: "Optimise database instance parameters — memory allocation, buffer pools, parallelism, I/O configuration — for your specific workload profile and hardware characteristics.",
      icon: <Settings2 className="w-6 h-6" />,
    },
    {
      title: "Security Hardening & VAPT",
      description: "Harden database configurations against security threats — removing default accounts, enforcing least-privilege access, encrypting sensitive columns, auditing privileged activity, and conducting VAPT assessments.",
      icon: <ShieldCheck className="w-6 h-6" />,
    },
    {
      title: "Audit & Activity Monitoring",
      description: "Implement database audit frameworks — Oracle Unified Auditing, SQL Server Audit, pgAudit — to capture and retain user activity, DDL changes, and data access events for compliance and forensic investigation.",
      icon: <Eye className="w-6 h-6" />,
    },
    {
      title: "Capacity & Growth Planning",
      description: "Monitor data growth trends, object sizes, and resource consumption — providing forward-looking capacity recommendations to prevent performance degradation before it happens.",
      icon: <TrendingUp className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Database Performance", "Query Tuning", "Index Optimisation", "Database Security", "VAPT", "Oracle", "MSSQL", "PostgreSQL", "Audit"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/Performance-Tuning-Security.png')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Databases that run fast, stay secure, and hold up under the pressure of financial operations at scale.
            </p>
            ...
            >
              {[
                { value: "17h→40m", label: "Batch Speedup" },
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Performance & Security: Two Sides of the Same Coin
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Database performance and security require deep expertise, continuous attention, and a proactive mindset.
                  </p>
                  <p>
                    Newel's Database Performance Tuning & Security practice improves query response times, batch processing throughput, and overall database stability — while hardening your database environments against security threats and ensuring audit compliance.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  <img 
                    src="/Performance-Tuning-Security.png" 
                    alt="Database Performance Visual" 
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Precision Engineering</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Proven Impact</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel reduced LMS repayment batch processing from 17 hours to 40 minutes through targeted performance engineering.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We bring the same rigour — combining query optimisation, indexing, and parallel processing — to every database engagement."
                    </p>
                  </div>

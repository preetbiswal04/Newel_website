...
export default function AppModernizationPage() {
  const offerings = [
    {
      title: "Modernisation Assessment & Roadmap",
      description: "Assess your application portfolio for priority — evaluating business criticality, technical debt, and cloud fit — with a phased roadmap that balances speed and stability.",
      icon: <Search className="w-6 h-6" />,
    },
    {
      title: "Monolith to Microservices",
      description: "Decompose monolithic applications into independently deployable microservices — enabling faster releases and team autonomy without a big-bang rewrite.",
      icon: <Grid className="w-6 h-6" />,
    },
    {
      title: "Re-platforming to Cloud-Native",
      description: "Move applications from legacy infrastructure to cloud-native platforms — containerising workloads, adopting managed services, and implementing auto-scaling.",
      icon: <Cloud className="w-6 h-6" />,
    },
    {
      title: "Technology Stack Upgrade",
      description: "Migrate from end-of-life frameworks and languages to modern, supported stacks — improving security, performance, and talent attraction.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "API-First Enablement",
      description: "Re-architect applications with an API-first approach — enabling integration with modern systems, partner ecosystems, mobile apps, and AI tools.",
      icon: <Share2 className="w-6 h-6" />,
    },
    {
      title: "DevOps & CI/CD Implementation",
      description: "Implement modern DevOps practices — automated testing, pipelines, and observability — to improve release velocity and reliability.",
      icon: <Workflow className="w-6 h-6" />,
    },
  ];

  const tags = [
    "App Modernisation", "Microservices", "Cloud-Native", "AWS", "Containers", "DevOps", "Legacy Migration", "Financial Services"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/app-modernization-img.jpg')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Move beyond legacy — modernise your applications for the cloud era without disrupting the business they support.
            </p>
            ...
            >
              {[
                { value: "20+", label: "Modernisations" },
                { value: "5x", label: "Faster Ship" },
                { value: "60%", label: "Lower Debt" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Legacy applications slow you down. They're expensive to maintain, difficult to scale, and a barrier to adopting AI, automation, and modern integrations.
                  </p>
                  <p>
                    Newel's App Modernisation practice helps organisations systematically move from outdated architectures to modern, cloud-native platforms — improving performance, reducing technical debt, and enabling faster innovation.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  >
                    <source src="/app-modernization-vd.mp4" type="video/mp4" />
                  </video>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Transformation Engineering</span>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has delivered 20+ app modernisation projects for financial services clients.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "Including a full cloud-native re-architecture on AWS — migrating from monolithic legacy apps to modern NextJS, NestJS, and EKS stacks."
                    </p>
                  </div>

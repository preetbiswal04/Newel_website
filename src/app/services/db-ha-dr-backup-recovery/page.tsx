...
export default function DBHighAvailabilityPage() {
  const offerings = [
    {
      title: "Oracle RAC & Data Guard",
      description: "Design and implement Oracle Real Application Clusters (RAC) for high availability and Oracle Data Guard for standby database replication — providing automatic failover and zero data loss configurations.",
      icon: <Activity className="w-6 h-6" />,
    },
    {
      title: "SQL Server AlwaysOn Availability Groups",
      description: "Implement SQL Server AlwaysOn for synchronous and asynchronous database replication — with automatic failover, readable secondaries, and distributed availability groups for multi-site HA.",
      icon: <Layers className="w-6 h-6" />,
    },
    {
      title: "PostgreSQL HA (Patroni, Streaming Replication)",
      description: "Set up PostgreSQL high availability using streaming replication and Patroni-managed automatic failover — providing enterprise-grade HA without Oracle licensing costs.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "MongoDB Replica Sets & Sharding",
      description: "Configure MongoDB replica sets for high availability and sharding for horizontal scalability — ensuring your NoSQL data tier is as resilient as your relational databases.",
      icon: <Grid className="w-6 h-6" />,
    },
    {
      title: "Backup Strategy Design & Implementation",
      description: "Design multi-tiered backup strategies — full, incremental, and archive — with offsite and cloud-based backup targets, retention policies, and encryption aligned to regulatory requirements.",
      icon: <ShieldCheck className="w-6 h-6" />,
    },
    {
      title: "DR Testing & RTO/RPO Validation",
      description: "Conduct regular DR drills — validating failover procedures, measuring actual recovery times, and updating runbooks to reflect current configurations and business requirements.",
      icon: <RotateCcw className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Database HA", "Oracle RAC", "Data Guard", "SQL Server AlwaysOn", "PostgreSQL HA", "MongoDB", "Disaster Recovery", "Backup"
  ];
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/ha-DR-Backup-Recovery.jpg')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Database availability and recoverability you can count on — designed, tested, and maintained to your RTO and RPO.
            </p>
            ...
            >
              {[
                ...
                { value: "<5m", label: "Recovery Time" },
                { value: "100%", label: "Tested Integrity" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    A database outage in a financial institution is never just a technical problem — it's a business and regulatory problem.
                  </p>
                  <p>
                    Newel designs and implements High Availability and Disaster Recovery architectures for your database environments — ensuring that whether you face a server failure, data centre outage, or human error, your databases recover fast and your data is protected.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  <img 
                    src="/ha-DR-Backup-Recovery.jpg" 
                    alt="Database HA & DR Visual" 
      ...
      <section className="bg-zinc-950 py-32 relative overflow-hidden">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-cyan-400 font-black text-xs uppercase tracking-[0.3em]">Resilience Solutions</span>
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-br from-white/[0.05] to-transparent p-12 md:p-20 rounded-[40px] border border-white/10 backdrop-blur-sm">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-cyan-400 font-black text-xs uppercase tracking-[0.3em]">Built for Rigour</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-white/90 leading-snug">
                    Newel has designed HA/DR architectures for mission-critical financial databases where data loss and extended downtime are simply not acceptable.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-white/60 italic leading-relaxed">
                      "We design these systems with the rigour that regulated environments demand."
                    </p>
                  </div>

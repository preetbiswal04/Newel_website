  ...
  const offerings = [
    {
      ...
      description: "Access a pre-vetted pool of technical experts across various domains including Cloud, AI, and Infrastructure, with deployment times as low as 48 hours.",
      icon: <Clock className="w-6 h-6" />,
    },
    {
      title: "Third-Party Payroll Management",
      description: "End-to-end management of contract staff payroll, including compliance, taxation, and benefits, reducing your administrative overhead and legal risks.",
      icon: <Shield className="w-6 h-6" />,
    },
    {
      title: "Technical Vetting & Assessment",
      description: "Rigorous technical screening process conducted by subject matter experts to ensure that only the highest quality talent reaches your projects.",
      icon: <CheckCircle className="w-6 h-6" />,
    },
    {
      title: "Project-Based Scalability",
      description: "Scale your technical workforce up or down based on specific project requirements, ensuring cost-efficiency and operational flexibility.",
      icon: <Activity className="w-6 h-6" />,
    },
    {
      title: "Global Talent Sourcing",
      description: "Leverage our extensive network to find specialized talent globally, ensuring you have the right expertise regardless of location.",
      icon: <Globe className="w-6 h-6" />,
    },
    {
      title: "Dedicated Account Management",
      description: "Personalized support throughout the staffing lifecycle, from initial requirement gathering to ongoing resource performance management.",
      icon: <Users className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Contract Staffing", "Payroll Management", "Third-Party Hiring", "Staff Augmentation", "Technical Sourcing", "Agile Workforce"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Access top-tier technical talent on demand. Flexible and scalable solutions tailored to your project timelines.
            </p>
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Beyond Hiring: Strategic Talent Supply
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    We manage the entire talent lifecycle for your contract needs. From rapid sourcing and rigorous vetting to third-party payroll management, we ensure you have the right experts at the right time.
                  </p>
                  <p>
                    Our approach combines speed with quality, leveraging a deep network of technical professionals to fill critical gaps in your teams and accelerate project delivery.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Agile Workforce Solutions</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Proven Talent Partner</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has a proven track record of supplying high-impact technical resources to leading financial and technology firms.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We don't just find people; we find the right fit for your specific technical environment and business culture."
                    </p>
                  </div>

...
import { PhoneCall, Briefcase, Sparkles, Users, Clock, CheckCircle, Shield, Globe, Activity } from "lucide-react";
...
export default function ContractStaffingPage() {
  return (
    <main className="min-h-screen overflow-hidden" style={{ fontFamily: 'RecklessNeue, sans-serif' }}>
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-start">
          ...
          >
            ...
            >
              ...
              Flexible and Scalable Solutions for Your Project Needs
            </motion.div>
            ...
            <p className="text-lg md:text-xl text-white/70 font-medium leading-relaxed max-w-2xl">
              Access top-tier technical talent on demand. We provide flexible and 
              scalable contract staffing solutions tailored to your specific 
      ...
      {/* ── Section 2: Contract Staffing Details ── */}
              ...
              <div className="lg:w-1/2 p-10 md:p-14 flex flex-col justify-center space-y-8">
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-4xl font-black text-white leading-tight">
                    Beyond Hiring: <br /> Strategic Talent Supply
                  </h2>
                  <p className="text-white/60 text-base md:text-lg leading-relaxed font-medium">
                    We manage the entire talent lifecycle for your contract needs. From 
                    rapid sourcing and rigorous vetting to third-party payroll 
                    management, we ensure you have the right experts at the right time.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { icon: <Clock size={20} />, text: "Rapid Onboarding" },
                    { icon: <CheckCircle size={20} />, text: "Rigorous Vetting" },
                    { icon: <Shield size={20} />, text: "Payroll Management" },
                    { icon: <Globe size={20} />, text: "Global Talent Pool" },
                  ].map((item) => (
                    <div
                      key={item.text}
                ...
                >
                  ...
                  <span className="relative z-10 bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent group-hover:text-white transition-colors duration-500">Hire Now</span>
                </Link>
              </div>
            </div>
          </motion.div>

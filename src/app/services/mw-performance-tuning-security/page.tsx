...
export default function MWPerformanceSecurityPage() {
  const offerings = [
    {
      title: "JVM Performance Tuning",
      description: "Optimise JVM heap settings, garbage collection algorithms and parameters, thread pool configuration, and class loading — eliminating GC pauses, memory leaks, and thread contention.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Connection Pool Tuning",
      description: "Analyse and optimise JDBC connection pool settings — pool sizing, timeout configuration, connection validation, and leak detection — to ensure efficient database connectivity under peak load.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "WebLogic / WebSphere / JBoss Tuning",
      description: "Platform-specific performance tuning — work manager configuration, EJB pool sizing, JMS tuning, HTTP session management, and request queue optimisation for your specific application workload.",
      icon: <Settings className="w-6 h-6" />,
    },
    {
      title: "Security Hardening",
      description: "Harden middleware configurations against security threats — disabling unnecessary services, enforcing SSL/TLS, configuring LDAP authentication, removing default credentials, and applying security patches.",
      icon: <ShieldCheck className="w-6 h-6" />,
    },
    {
      title: "VAPT & Security Assessment",
      description: "Conduct vulnerability assessments of middleware environments — identifying misconfigurations, exposed admin consoles, weak authentication, and outdated components.",
      icon: <Search className="w-6 h-6" />,
    },
    {
      title: "SSL/TLS Certificate Management",
      description: "Manage SSL/TLS certificates across middleware environments — certificate renewal, keystore management, cipher suite configuration, and TLS protocol hardening.",
      icon: <Lock className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Middleware Performance", "JVM Tuning", "WebLogic", "WebSphere", "JBoss", "Tomcat", "Security Hardening", "VAPT", "SSL"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Middleware that performs under pressure and holds up against security threats — both non-negotiable in financial services.
            </p>
            ...
            >
              {[
                ...
                { value: "Zero", label: "Pool Exhaustion" },
                { value: "Hardened", label: "Security" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Eliminating the Middleware Bottleneck
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Middleware performance problems often masquerade as application problems. Slow response times, connection pool exhaustion, and memory leaks can bring performance to its knees — without a single line of bad application code.
                  </p>
                  <p>
                    Newel's practice addresses these issues at the source — optimising your middleware stack and hardening it against evolving security threats.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  <img 
                    src="/home-img-7.jpg" 
                    alt="Middleware Performance & Security Visual" 
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Advanced Optimization</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Operational Resilience</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has tuned WebLogic and JBoss environments for financial applications processing high transaction volumes.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We understand that milliseconds of middleware latency translate directly into business impact. Our tuning ensures your stack is always production-ready."
                    </p>
                  </div>

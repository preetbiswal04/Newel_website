...
export default function OSHighAvailabilityPage() {
  const offerings = [
    {
      title: "HA Architecture Design",
      description: "Design high availability architectures for Linux and Windows environments — active-active and active-passive clustering, load balancing, and failover configurations tailored to your workload requirements.",
      icon: <Layout className="w-6 h-6" />,
    },
    {
      title: "Clustering & Failover Setup",
      description: "Implement OS-level clustering — Windows Server Failover Clustering (WSFC), Linux Pacemaker/Corosync — for critical workloads that require automatic failover and minimal downtime.",
      icon: <Grid className="w-6 h-6" />,
    },
    {
      title: "DR Planning & Implementation",
      description: "Design and implement disaster recovery strategies — defining RTO and RPO targets, selecting appropriate DR mechanisms, and configuring replication and failover procedures.",
      icon: <FileSpreadsheet className="w-6 h-6" />,
    },
    {
      title: "DR Drills & Testing",
      description: "Conduct regular DR drills to validate that failover procedures work as designed — documenting results, identifying gaps, and updating runbooks to reflect current architecture.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Backup & Recovery Architecture",
      description: "Design multi-tiered backup strategies — local, remote, and cloud-based — with defined retention policies, encryption, and tested recovery procedures.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "RTO/RPO Validation",
      description: "Test and validate your actual recovery time and recovery point objectives — ensuring your DR capability meets business and regulatory requirements, not just design targets.",
      icon: <CheckCircle className="w-6 h-6" />,
    },
  ];

  const tags = [
    "High Availability", "Disaster Recovery", "Linux HA", "Windows Clustering", "RTO", "RPO", "DR Testing", "Financial Services"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/High-Availability-DR.jpg')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Build an OS infrastructure that doesn't go down — and recovers fast when the unexpected happens.
            </p>
            ...
            >
              {[
                { value: "RTO", label: "Optimised" },
                { value: "Zero", label: "Data Loss" },
                { value: "100%", label: "Failover Success" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    In financial services, system availability is revenue. A server outage during market hours, EOD processing, or a loan disbursement run is not a minor inconvenience — it's a business-critical event.
                  </p>
                  <p>
                    Newel designs and implements High Availability and Disaster Recovery architectures for your OS infrastructure — ensuring continuity, minimising RTO, and giving your operations team the confidence that comes from knowing you've planned for failure.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Business Continuity</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Resilient Design</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has designed and managed HA/DR architectures for financial services where system availability is directly tied to business continuity.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We design for failure — so failure doesn't become a crisis for your business or regulatory standing."
                    </p>
                  </div>

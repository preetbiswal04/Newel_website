  ...
  const offerings = [
    {
      ...
      description: "Deep-dive analysis of your datasets to understand distributions, correlations, outliers, and data quality issues — the foundation for any reliable analytical or AI initiative.",
      icon: <Search className="w-6 h-6" />,
    },
    {
      title: "Business Intelligence & Reporting",
      description: "Design and build interactive dashboards and automated reports using tools like Power BI, Tableau, or custom web-based visualisations — giving teams real-time visibility into KPIs.",
      icon: <BarChart3 className="w-6 h-6" />,
    },
    {
      title: "Operational Analytics",
      description: "Analyse process data across loan servicing, compliance, customer operations, and infrastructure to identify inefficiencies and improvement opportunities.",
      icon: <Activity className="w-6 h-6" />,
    },
    {
      title: "Customer & Portfolio Analytics",
      description: "Understand customer segments, repayment behaviour, risk concentration, and portfolio performance through structured analytical models tailored to financial services.",
      icon: <Users className="w-6 h-6" />,
    },
    {
      title: "Compliance & Audit Analytics",
      description: "Build analytical frameworks that support regulatory reporting, audit readiness, and compliance monitoring — reducing manual effort and improving accuracy.",
      icon: <FileText className="w-6 h-6" />,
    },
    {
      title: "Ad-Hoc & Self-Serve Analytics",
      description: "Empower business teams with self-serve analytical tools and curated data models, reducing dependency on IT for every data request.",
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            >
              ...
              Insights for Data-Informed Decisions
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              From raw data to decisions — we help you see what's happening, understand why, and act with confidence.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Data without analysis is just noise. Newel's Data Analysis practice helps organisations make sense of their data — surfacing patterns, identifying anomalies, and turning complex datasets into clear, actionable insight.
                  </p>
                  <p>
                    Whether you're looking to improve operational efficiency, understand customer behaviour, or strengthen compliance reporting, we bring the analytical rigour and domain knowledge to deliver answers that matter.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden">
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-600/5 blur-[180px] rounded-full pointer-events-none" />
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has delivered analytics solutions across risk, compliance, loan operations, and infrastructure for financial institutions.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We combine strong domain knowledge with technical depth — so our analysis doesn't just look good on a dashboard, it drives real decisions."
                    </p>
                  </div>
               </div>
            </div>

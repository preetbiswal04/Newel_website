...
import { PhoneCall, Users, Sparkles, Activity, Share2, Workflow, Clock, Search, Zap } from "lucide-react";
...
export default function StaffAugmentationPage() {
  return (
    <main className="min-h-screen overflow-hidden" style={{ fontFamily: 'RecklessNeue, sans-serif' }}>
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-start">
          ...
          >
            ...
            >
              ...
              Scale Your Technical Teams with Expert Professionals
            </motion.div>
            ...
            <p className="text-lg md:text-xl text-white/70 font-medium leading-relaxed max-w-2xl">
              Boost your team's velocity. We provide expert IT professionals who 
              seamlessly integrate with your existing teams to accelerate 
              delivery and close critical skill gaps.
            </p>
      ...
      {/* ── Section 2: Staff Augmentation Details ── */}
              ...
              <div className="lg:w-1/2 p-10 md:p-14 flex flex-col justify-center space-y-8">
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-4xl font-black text-white leading-tight">
                    Beyond Augmenting: <br /> Seamless Team Integration
                  </h2>
                  <p className="text-white/60 text-base md:text-lg leading-relaxed font-medium">
                    Our professionals don't just work for you; they work with you. We 
                    specialize in providing senior-level engineers and specialists who 
                    understand your culture and sprint rhythm from day one.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { icon: <Clock size={20} />, text: "Zero Lag Integration" },
                    { icon: <Share2 size={20} />, text: "Senior Skillsets" },
                    { icon: <Workflow size={20} />, text: "Sprint-Ready Talent" },
                    { icon: <Search size={20} />, text: "Domain Specialists" },
                  ].map((item) => (
                    <div
                      key={item.text}
                ...
                >
                  ...
                  <span className="relative z-10 bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent group-hover:text-white transition-colors duration-500">Scale Today</span>
                </Link>
              </div>
            </div>
          </motion.div>

...
export default function MWUpgradesAutomationPage() {
  const offerings = [
    {
      title: "Middleware Version Upgrades",
      description: "Plan and execute WebLogic, WebSphere, JBoss, and Tomcat version upgrades — with application compatibility assessment, configuration migration, staged rollout, and post-upgrade performance validation.",
      icon: <ArrowUpCircle className="w-6 h-6" />,
    },
    {
      title: "Platform Migration",
      description: "Migrate from one middleware platform to another — for example, JBoss to Tomcat, WebSphere to WebLogic — with configuration translation, deployment adaptation, and application testing.",
      icon: <Share2 className="w-6 h-6" />,
    },
    {
      title: "Migration to Cloud-Native (Containers)",
      description: "Migrate traditional middleware deployments to containerised environments — packaging applications in Docker, deploying on Kubernetes (EKS/AKS), and replacing middleware functions with cloud-native alternatives where appropriate.",
      icon: <Box className="w-6 h-6" />,
    },
    {
      title: "Middleware Automation & Scripting",
      description: "Build automation for middleware operations — WLST scripts for WebLogic, Python/Ansible playbooks for configuration management, automated deployment scripts, and health check automation.",
      icon: <Terminal className="w-6 h-6" />,
    },
    {
      title: "Configuration as Code",
      description: "Implement infrastructure-as-code practices for middleware configuration — version-controlled configuration templates, automated environment provisioning, and consistent configuration drift detection.",
      icon: <Code className="w-6 h-6" />,
    },
    {
      title: "Post-Migration Validation & Optimisation",
      description: "Comprehensive post-migration validation — functional testing, performance benchmarking, security review, and configuration optimisation — ensuring the upgraded or migrated environment performs to expectations.",
      icon: <CheckCircle2 className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Middleware Upgrade", "WebLogic Migration", "JBoss", "Tomcat", "WebSphere", "Automation", "Containers", "WLST", "Ansible"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Move to newer middleware versions and automate the operational overhead — without disrupting the applications that depend on them.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Precision Lifecycle Execution
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Middleware upgrade and migration projects carry real risk — application compatibility, downtime windows, and configuration complexity all require careful planning.
                  </p>
                  <p>
                    Newel manages these projects end-to-end — from initial assessment and planning through execution and post-migration validation — for WebLogic, WebSphere, JBoss, Tomcat, and related platforms.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  <img 
                    src="/home-img-7.jpg" 
                    alt="Middleware Upgrades & Migration Visual" 
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Lifecycle Excellence</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Proven Precision</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has managed middleware upgrades and migrations for financial services clients with zero-downtime requirements.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We plan every step with the precision that regulated environments demand, ensuring your modernization journey is seamless and risk-free."
                    </p>
                  </div>

  ...
  const offerings = [
    {
      ...
      description: "Design and develop professional corporate websites that communicate your brand, services, and value proposition clearly and credibly.",
      icon: <Building2 className="w-6 h-6" />,
    },
    {
      title: "Landing Pages & Campaign Sites",
      description: "High-conversion landing pages built for specific products, campaigns, or audience segments — optimised for speed and designed to drive action.",
      icon: <Target className="w-6 h-6" />,
    },
    {
      title: "CMS-Driven Websites",
      description: "Build content-managed websites on platforms like WordPress, Webflow, or custom CMS solutions — empowering your marketing team to update content without developer dependency.",
      icon: <Settings className="w-6 h-6" />,
    },
    {
      title: "Web Application Front-Ends",
      description: "Develop responsive, accessible front-end interfaces for web applications using React, Angular, or Next.js — optimised for performance and cross-device compatibility.",
      icon: <Monitor className="w-6 h-6" />,
    },
    {
      title: "SEO & Performance Optimisation",
      description: "Ensure your website loads fast, ranks well, and delivers a smooth experience — covering Core Web Vitals, structured data, accessibility, and technical SEO.",
      icon: <Gauge className="w-6 h-6" />,
    },
    {
      title: "Website Revamp & Modernisation",
      description: "Transform outdated websites into modern, high-performing digital experiences — preserving your existing SEO equity while upgrading design, technology, and usability.",
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/Web-Development Page.png')",
      ...
      >
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            >
              <Layout size={16} className="animate-pulse" />
              Websites Built to Drive Business Outcomes
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Clean, fast, and conversion-focused websites — built to represent your brand and drive business outcomes.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Your website is often the first impression a client, partner, or candidate has of your organisation. 
                    Newel builds websites that are visually sharp, technically sound, and built with purpose — whether that's generating leads, communicating credibility, or serving as a product front-end.
                  </p>
                  <p>
                    We combine modern web technologies with a strong understanding of performance, SEO, and user experience to deliver websites that work.
                  </p>
                </div>
             </motion.div>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel brings together design sensibility and engineering rigour — we don't just make things look good, we make them work.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "Our websites are built on clean, maintainable code with performance and security built in from the start."
                    </p>
                  </div>
               </div>
            </div>

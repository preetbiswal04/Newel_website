  ...
  const offerings = [
    {
      ...
      description: "Deploy intelligent chatbots on your website, app, or WhatsApp that handle customer queries, loan FAQs, repayment information, and service requests — with fallback to human agents where needed.",
      icon: <MessageSquare className="w-6 h-6" />,
    },
    {
      title: "Internal Knowledge Assistants",
      description: "Build enterprise knowledge assistants that let your teams query internal documents, SOPs, compliance manuals, and policy repositories in plain language — reducing time spent searching and improving consistency.",
      icon: <BookOpen className="w-6 h-6" />,
    },
    {
      title: "AI Copilots for Operations",
      description: "Embed AI copilots into your workflows — loan processing, compliance review, customer service — that assist staff with contextual suggestions, document summarisation, and automated drafts.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Document Processing & Extraction",
      description: "Use GenAI to extract, classify, and summarise information from unstructured documents — loan agreements, KYC documents, audit reports, and customer correspondence.",
      icon: <FileSearch className="w-6 h-6" />,
    },
    {
      title: "RAG-Based Solutions (Retrieval-Augmented Generation)",
      description: "We build RAG pipelines that ground GenAI responses in your proprietary data — ensuring accuracy, reducing hallucinations, and making responses auditable.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "Governance & Safety Guardrails",
      description: "Every GenAI solution we build includes content filtering, output validation, access controls, and audit logging — essential for regulated environments.",
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/genAI-11.avif')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            >
              ...
              Operational AI for Financial Services
            </motion.div>
            ...
            <h1 className="text-4xl md:text-6xl font-black text-white leading-[1.05] tracking-tight">
              ...
              <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent">
                (Chatbots, Copilots, Knowledge Assistants)
              </span>
            </h1>

            {/* Subtitle */}
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              AI that works with your people — not around them. Purpose-built Generative AI for financial services and enterprise operations.
            </p>
            ...
            >
              {[
                { value: "4x", label: "Faster Response" },
                { value: "90%", label: "Intent Accuracy" },
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    ...
                    But the difference between a useful GenAI deployment and a failed pilot is how well it's grounded in your data, your processes, and your governance requirements.
                  </p>
                  <p>
                    Newel builds production-ready Generative AI solutions — chatbots, copilots, and knowledge assistants — designed specifically for the compliance, security, and usability needs of financial services and enterprise environments.
                  </p>
                </div>
             </motion.div>
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-br from-white/[0.05] to-transparent p-12 md:p-20 rounded-[40px] border border-white/10 backdrop-blur-sm">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-cyan-400 font-black text-xs uppercase tracking-[0.3em]">Industry Recognition</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-white/90 leading-snug">
                    Newel was recognised at the Enqube Industry Event for AI-Driven Risk & Compliance Innovation.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-white/60 italic leading-relaxed">
                      "We build Generative AI systems that financial institutions can trust — responsible, governed, and aligned to RBI and compliance expectations."
                    </p>
                  </div>
               </div>
            </div>

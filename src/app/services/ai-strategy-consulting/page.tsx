...
export default function AIStrategyPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      {/* ── Section 5: Impact in Action ── */}
      <section className="bg-black border-t border-white/10">
        <div className="container-page mx-auto pt-16 -mb-16 relative z-20 text-center lg:text-left">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-4">
            Impact in <span className="text-cyan-400 drop-shadow-[0_0_15px_rgba(34,211,238,0.4)]">Action</span>
          </h2>
          <p className="text-white/60 text-lg max-w-2xl font-medium">
            See how we’ve helped industry leaders navigate the AI landscape and 
            achieve measurable business transformations.
          </p>
        </div>

        {(() => {
          const caseStudy = CASE_STUDIES.find(cs => cs.slug === "qrc-classification-ai");

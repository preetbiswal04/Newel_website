...
export default function OSSecurityHardeningPage() {
  const offerings = [
    {
      title: "CIS Benchmark Hardening",
      description: "Apply CIS Benchmark configurations for Linux (RedHat, Ubuntu, CentOS) and Windows Server — removing unnecessary services, enforcing secure defaults, and reducing attack surface.",
      icon: <Shield className="w-6 h-6" />,
    },
    {
      title: "Kernel Tuning & Security Parameters",
      description: "Configure Linux kernel parameters for security — network stack hardening, core dump restrictions, secure file system mounts, and audit logging configuration.",
      icon: <Settings className="w-6 h-6" />,
    },
    {
      title: "Access Control & Privilege Management",
      description: "Implement least-privilege access controls, PAM configuration, SSH hardening, sudo policy management, and privileged access review processes.",
      icon: <Lock className="w-6 h-6" />,
    },
    {
      title: "Audit Logging & SIEM Integration",
      description: "Configure comprehensive OS audit logging — tracking user activity, privilege escalation, file access, and system events — with SIEM integration for centralised security monitoring.",
      icon: <Eye className="w-6 h-6" />,
    },
    {
      title: "Vulnerability Scanning & Remediation",
      description: "Conduct regular OS-level vulnerability scans, prioritise findings by risk, and manage remediation through a structured patch and configuration change process.",
      icon: <Search className="w-6 h-6" />,
    },
    {
      title: "Compliance Reporting",
      description: "Generate compliance reports against regulatory frameworks and internal security policies — supporting audit readiness and providing evidence of ongoing security controls.",
      icon: <FileCheck className="w-6 h-6" />,
    },
  ];

  const tags = [
    "OS Hardening", "CIS Benchmark", "Linux Security", "Windows Security", "Audit Logging", "Vulnerability Management", "Compliance"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Harden your servers against threats and keep them compliant — without disrupting the applications that run on them.
            </p>
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Unhardened Servers are Vulnerabilities
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    An unhardened server is an open door. In financial services, where sensitive customer data, transaction records, and regulatory obligations are at stake, OS security hardening is non-negotiable.
                  </p>
                  <p>
                    Newel's OS Security Hardening & Compliance practice systematically reduces the attack surface of your Linux and Windows servers — aligned to CIS benchmarks, RBI IT guidelines, and your internal security policies.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Cyber Resilience</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Compliance Expertise</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel applies security hardening as a standard practice across all managed OS environments — not as a one-time project.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "Our financial services clients operate in environments where regulators and auditors scrutinise server configurations closely."
                    </p>
                  </div>

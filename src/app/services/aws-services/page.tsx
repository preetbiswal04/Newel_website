  ...
  const offerings = [
    {
      ...
      description: "Design, deploy, and manage AWS compute workloads — from traditional EC2 instances to containerised deployments and serverless functions.",
      icon: <Cpu className="w-6 h-6" />,
    },
    {
      title: "Data Services (RDS, DynamoDB, Redshift, S3)",
      description: "Architect and manage AWS data services for operational and analytical workloads — relational, NoSQL, data warehousing, and object storage.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "Serverless & Event-Driven Architecture",
      description: "Build serverless applications using Lambda, API Gateway, SQS, SNS, and EventBridge — reducing overhead while enabling scalable processing.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Container Services (EKS, ECS, ECR)",
      description: "Deploy and manage containerised workloads on AWS using EKS (Kubernetes) or ECS — with horizontal auto-scaling and blue-green deployments.",
      icon: <Layers className="w-6 h-6" />,
    },
    {
      title: "Data Pipelines (Glue, Kinesis, Step Functions)",
      description: "Build and manage AWS data pipelines for batch and real-time processing — using Glue for ETL and Step Functions for orchestration.",
      icon: <Workflow className="w-6 h-6" />,
    },
    {
      title: "Security & Identity (IAM, WAF, Security Hub)",
      description: "Implement AWS security best practices — IAM governance, WAF, GuardDuty, and Security Hub — to maintain a strong security posture.",
      icon: <Shield className="w-6 h-6" />,
    },
  ];

  const tags = [
    "AWS", "EC2", "EKS", "Lambda", "RDS", "S3", "Serverless", "Containers", "AWS Security", "Financial Services"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Deep AWS expertise across compute, data, serverless, containers, and security — delivering cloud that performs.
            </p>
            ...
            >
              {[
                ...
                { value: "100+", label: "DB Instances" },
                { value: "1k+", label: "Lambda Functions" },
              ].map((stat) => (
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Beyond Breadth: Depth that Matters
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    AWS is the world's leading cloud platform — but breadth of services doesn't automatically translate to good outcomes. You need expertise in the services that matter for your workloads, and the operational discipline to keep them running well.
                  </p>
                  <p>
                    Newel's AWS practice covers the full range of AWS services — from core compute and storage to containers, serverless, data services, and security — with hands-on delivery experience across financial services environments.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-zinc-950 py-32 relative overflow-hidden">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-cyan-400 font-black text-xs uppercase tracking-[0.3em]">AWS Specializations</span>
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-br from-white/[0.05] to-transparent p-12 md:p-20 rounded-[40px] border border-white/10 backdrop-blur-sm">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-cyan-400 font-black text-xs uppercase tracking-[0.3em]">Partner Expertise</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-white/90 leading-snug">
                    Newel is an AWS partner managing complex, multi-account AWS environments.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-white/60 italic leading-relaxed">
                      "Our team has hands-on experience across the entire AWS service portfolio — delivering production-ready solutions for financial services."
                    </p>
                  </div>

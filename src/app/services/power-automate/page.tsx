  ...
  const offerings = [
    {
      ...
      description: "Automate multi-step business processes — approvals, notifications, document routing, and status updates — across Microsoft 365 and connected business applications.",
      icon: <Workflow className="w-6 h-6" />,
    },
    {
      title: "Data Validation & Reconciliation Flows",
      description: "Build automated validation workflows that pull data from multiple sources, apply business rules, flag exceptions, and generate structured output reports — eliminating manual reconciliation effort.",
      icon: <CheckCircle className="w-6 h-6" />,
    },
    {
      title: "System Integration Flows",
      description: "Connect Power Automate to external systems via APIs, connectors, and custom integrations — enabling seamless data flow between your Microsoft environment and third-party platforms.",
      icon: <LinkIcon className="w-6 h-6" />,
    },
    {
      title: "Attended & Scheduled Automation",
      description: "Build both user-triggered (attended) flows and scheduled unattended flows — covering everything from on-demand approvals to nightly batch processing.",
      icon: <Clock className="w-6 h-6" />,
    },
    {
      title: "Power Automate Desktop (RDA)",
      description: "Use Power Automate Desktop for UI-based automation of legacy applications and desktop workflows — bridging the gap between modern APIs and older systems.",
      icon: <Monitor className="w-6 h-6" />,
    },
    {
      title: "Governance & Centre of Excellence",
      description: "Help organisations establish Power Platform governance frameworks — environment strategy, DLP policies, naming conventions, and maker enablement — so automation scales responsibly.",
      icon: <ShieldCheck className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Power Automate", "Microsoft 365", "Workflow Automation", "RPA", "Data Validation", "SharePoint", "Teams"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/power-automate-11.png')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Microsoft-native automation that connects your people, data, and systems — without the heavy RPA overhead.
            </p>
            ...
            >
              {[
                { value: "M365", label: "Native stack" },
                { value: "0", label: "RPA Overhead" },
                { value: "Full", label: "Governance" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Your Fastest Path to Automation
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    If your organisation runs on Microsoft 365, Power Automate is your fastest path to automation. Newel builds Power Automate workflows that connect Teams, SharePoint, Excel, Outlook, Dynamics, and your line-of-business systems — automating approvals, notifications, data flows, and repetitive tasks across your organisation.
                  </p>
                  <p>
                    From simple flows to complex enterprise-grade automation, we design solutions that are maintainable, governed, and built to last.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  >
                    <source src="/power-automate-11-vd.mp4" type="video/mp4" />
                  </video>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Cloud Workflows</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Microsoft Expertise</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has implemented Power Automate solutions for loan servicing validation and compliance reporting.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We deliver measurable reductions in processing time and manual effort for leading financial institutions."
                    </p>
                  </div>

...
import { PhoneCall, Sparkles, Activity, CheckCircle2, TrendingUp, ShieldCheck } from "lucide-react";
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/70 font-medium leading-relaxed max-w-2xl">
              "In our banks we have people behaving like robots doing mechanical things, tomorrow we're going to have robots behaving like people." We streamline repetitive tasks to boost productivity.
            </p>
              ...
              <div className="lg:w-1/2 p-10 md:p-14 flex flex-col justify-center space-y-8">
                <div className="space-y-4">
                  <span className="inline-flex items-center gap-2 text-cyan-400 font-bold text-sm uppercase tracking-widest">
                    <Activity size={18} />
                    RPA Performance Impact
                  </span>
                  <h2 className="text-3xl md:text-4xl font-black text-white leading-tight">
                    Transform Your Workflow With Intelligent RPA
                  </h2>
                  <p className="text-white/60 text-base md:text-lg leading-relaxed font-medium">
                    The benefits of RPA adoption are significant. Payback is typically reported at less than 12 months, with an average 20% of full-time equivalent capacity provided by robots.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { icon: <ShieldCheck size={20} />, text: "Improved Compliance" },
                    { icon: <CheckCircle2 size={20} />, text: "Quality & Accuracy" },
                    { icon: <Activity size={20} />, text: "Improved Productivity" },
                    { icon: <TrendingUp size={20} />, text: "Significant Cost Reduction" },
                  ].map((item) => (
                    <div
                      key={item.text}

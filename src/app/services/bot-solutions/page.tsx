...
export default function BotSolutionsPage() {
  const offerings = [
    {
      title: "MIS & Reporting Bots",
      description: "Automate the collection, compilation, and distribution of daily MIS reports — pulling data from multiple systems, formatting outputs, and delivering reports to the right stakeholders on schedule.",
      icon: <BarChart3 className="w-6 h-6" />,
    },
    {
      title: "EOD / BOD Processing Bots",
      description: "Automate end-of-day and beginning-of-day batch processes — reconciliation runs, position updates, balance calculations, and system health checks — reducing overnight processing time and dependency on operations staff.",
      icon: <RefreshCw className="w-6 h-6" />,
    },
    {
      title: "Alert & Notification Bots",
      description: "Build bots that monitor data thresholds, system events, or transaction patterns and automatically generate and send alerts via email, Teams, or WhatsApp — ensuring the right people are informed instantly.",
      icon: <Bell className="w-6 h-6" />,
    },
    {
      title: "Data Entry & Migration Bots",
      description: "Automate high-volume data entry tasks — transferring data between systems, populating forms, updating records — eliminating manual keying errors and freeing staff for more meaningful work.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "Reconciliation Bots",
      description: "Build automated reconciliation workflows that compare data across systems, flag discrepancies, generate exception reports, and maintain audit-ready output — reducing the reconciliation cycle from hours to minutes.",
      icon: <CheckCircle className="w-6 h-6" />,
    },
    {
      title: "Loan Servicing & Validation Bots",
      description: "Automate loan servicing validation workflows — EMI file processing, SOA verification, bounce charge checks, and penalty calculations — with structured exception reporting and audit trails.",
      icon: <FileText className="w-6 h-6" />,
    },
  ];

  const tags = [
    "RPA Bots", "MIS Automation", "EOD Bot", "Reconciliation", "Alert Bot", "Data Entry", "Loan Servicing", "Power Automate", "UiPath"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/bot-solution-11.jpg')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            >
              ...
              Targeted Operations Automation
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Targeted automation for the operational tasks that consume your team's time every single day.
            </p>
            ...
            >
              {[
                { value: "Daily", label: "MIS Reporting" },
                { value: "0", label: "Keying Errors" },
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Focused, Reliable Bot Solutions
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Not every automation need is a large RPA programme. Some of the highest-value automation opportunities are specific, well-defined operational tasks — daily MIS reports, EOD processing, reconciliation runs, alert generation, and data entry.
                  </p>
                  <p>
                    Newel builds focused, reliable bot solutions for exactly these use cases — fast to deploy, easy to maintain, and immediately impactful to your daily operations.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  >
                    <source src="/bot-solution-vd-11.mp4" type="video/mp4" />
                  </video>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Operational Automation</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Domain Knowledge</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has deployed bots across alerts, MIS, EOD, and reconciliation for financial services clients.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We understand the operational rhythms of these businesses and build bots that fit seamlessly into daily workflows."
                    </p>
                  </div>

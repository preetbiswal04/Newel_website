  ...
  const offerings = [
    {
      ...
      description: "Design and build end-to-end data pipelines — batch and streaming — that collect, transform, and deliver clean data to your AI models and analytics platforms.",
      icon: <Workflow className="w-6 h-6" />,
    },
    {
      title: "Data Lake & Warehouse Architecture",
      description: "We architect and implement modern data lakes and warehouses (on AWS, Azure, or GCP) that centralise your data and make it accessible for AI workloads.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "Data Quality & Governance",
      description: "Implement data validation, lineage tracking, schema management, and quality monitoring frameworks to ensure your AI models train and infer on trustworthy data.",
      icon: <ShieldCheck className="w-6 h-6" />,
    },
    {
      title: "ETL / ELT Modernisation",
      description: "Migrate from legacy ETL tools to modern, scalable ELT frameworks — reducing pipeline maintenance overhead and improving data freshness.",
      icon: <RefreshCw className="w-6 h-6" />,
    },
    {
      title: "Feature Engineering & Feature Stores",
      description: "Build reusable feature pipelines and feature stores that accelerate model development and ensure consistency between training and production environments.",
      icon: <Layers className="w-6 h-6" />,
    },
    {
      title: "Real-Time Data Streaming",
      description: "Implement event-driven architectures using tools like Apache Kafka or AWS Kinesis for use cases that require low-latency AI inference — fraud detection, risk alerts, customer signals.",
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/Data-Engineering.png')",
      ...
      >
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-cyan-400/10 blur-[120px] rounded-full animate-pulse" style={{ animationDelay: "1.5s" }} />
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              AI is only as good as the data behind it. We build the pipelines, platforms, and foundations that make AI possible.
            </p>
      ...
      <section className="bg-black py-24 relative overflow-hidden border-t border-white/5">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-cyan-600/10 blur-[160px] rounded-full pointer-events-none" />
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Beyond the Model: <br /> Building Data Readiness
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Most AI projects don't fail because of the model — they fail because the data isn't ready. 
                    Siloed systems, inconsistent formats, poor data quality, and missing pipelines are the real blockers.
                  </p>
                  <p>
                    Newel's Data Engineering for AI practice focuses on exactly this — building robust, scalable data infrastructure that feeds reliable inputs into your AI and machine learning initiatives.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-zinc-950 py-32 relative overflow-hidden">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-cyan-400 font-black text-xs uppercase tracking-[0.3em]">Capabilities</span>
      ...
      <section className="bg-black py-32 relative overflow-hidden">
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-blue-600/10 blur-[180px] rounded-full pointer-events-none" />
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-br from-white/[0.05] to-transparent p-12 md:p-20 rounded-[40px] border border-white/10 backdrop-blur-sm">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-cyan-400 font-black text-xs uppercase tracking-[0.3em]">Proven Experience</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-white/90 leading-snug">
                    Newel has built data infrastructure for financial institutions managing millions of transactions, 
                    loan records, and customer interactions daily.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-white/60 italic leading-relaxed">
                      "We understand the data complexity of regulated environments and design pipelines that are audit-ready, secure, and production-grade from day one."
                    </p>
                  </div>
               </div>
            </div>

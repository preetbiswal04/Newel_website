...
import { PhoneCall, Sparkles, RefreshCw, Database, Code2, Laptop } from "lucide-react";
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/70 font-medium leading-relaxed max-w-2xl">
              Rapid changes in technology make aging applications a nightmare to maintain. We help you build state-of-the-art applications to leverage current technologies before discarding old systems.
            </p>
            ...
            >
              {[
                { value: "Seamless", label: "Migration" },
                { value: "0", label: "Data Loss" },
                { value: "100%", label: "Modernized" },
              ].map((stat) => (
              ...
              <div className="lg:w-1/2 p-10 md:p-14 flex flex-col justify-center space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-white/60 text-base md:text-lg leading-relaxed font-medium">
                    We strategically transition your critical applications to modern architectures, ensuring they are scalable, secure, and ready for future business demands.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { icon: <Laptop size={20} />, text: "Application Assessment" },
                    { icon: <Code2 size={20} />, text: "Language Upgradation" },
                    { icon: <RefreshCw size={20} />, text: "UI / UX Conversion" },
                    { icon: <Database size={20} />, text: "Database & Tech Upgrades" },
                  ].map((item) => (
                    <div
                      key={item.text}

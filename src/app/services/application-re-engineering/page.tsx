...
export default function ApplicationReEngineeringPage() {
  const offerings = [
    {
      title: "Legacy Application Assessment",
      description: "Comprehensive technical audit of your existing application — architecture, code quality, dependencies, performance bottlenecks, and modernisation risk — with a clear recommendation and roadmap.",
      icon: <Search className="w-6 h-6" />,
    },
    {
      title: "Monolith to Microservices Migration",
      description: "Decompose tightly coupled monolithic applications into independently deployable microservices — enabling faster releases, better scalability, and reduced deployment risk.",
      icon: <Shuffle className="w-6 h-6" />,
    },
    {
      title: "Technology Stack Modernisation",
      description: "Migrate from outdated frameworks and languages (.NET Framework, legacy Java, classic ASP) to modern, supported stacks — improving performance, security, and developer productivity.",
      icon: <Cpu className="w-6 h-6" />,
    },
    {
      title: "Cloud-Native Re-Architecture",
      description: "Re-architect applications to leverage cloud-native capabilities — containerisation, auto-scaling, managed services, and serverless — reducing infrastructure overhead and operational cost.",
      icon: <Cloud className="w-6 h-6" />,
    },
    {
      title: "Database Modernisation",
      description: "Migrate from legacy databases to modern relational or NoSQL alternatives, optimise schemas, and implement caching layers to improve performance and reduce licensing costs.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "UI/UX Modernisation",
      description: "Rebuild outdated front-ends with modern, responsive interfaces — improving usability, accessibility, and user adoption without rebuilding the entire back-end.",
      icon: <Smartphone className="w-6 h-6" />,
    },
  ];

  const tags = [
    "App Re-Engineering", "Legacy Modernisation", "Microservices", "Cloud-Native", "Technology Migration", "AWS"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/app-engeenring.png')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Transform legacy applications into modern, scalable platforms — without disrupting the business that depends on them.
            </p>
            ...
            >
              {[
                { value: "20+", label: "Modernized Apps" },
                { value: "Full", label: "AWS Migration" },
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Preserving Logic, upgrading tech
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Legacy applications carry years of business logic and institutional knowledge — but they also carry technical debt, scaling limitations, and maintenance burden.
                  </p>
                  <p>
                    Newel's App Re-Engineering practice modernises your existing applications — moving from monoliths to microservices, legacy stacks to modern frameworks, and on-premise to cloud — while preserving what works and improving what doesn't.
                  </p>
                </div>
             </motion.div>

...
export default function OSPerformanceAutomationPage() {
  const offerings = [
    {
      title: "OS Performance Tuning",
      description: "Deep-dive analysis of CPU, memory, I/O, and network bottlenecks — with targeted tuning of system parameters to improve application throughput and reduce latency.",
      icon: <Activity className="w-6 h-6" />,
    },
    {
      title: "Capacity Planning",
      description: "Analyze historical resource trends and growth patterns to forecast future requirements — ensuring your infrastructure scales ahead of business demand.",
      icon: <BarChart3 className="w-6 h-6" />,
    },
    {
      title: "Kernel & System Tuning (Linux)",
      description: "Advanced Linux tuning — memory management (hugepages, swappiness), I/O scheduler selection, network buffer optimization, and process priority management.",
      icon: <Cpu className="w-6 h-6" />,
    },
    {
      title: "Automation & Scripting",
      description: "Build automation frameworks using Ansible, Terraform, and Python to eliminate manual OS tasks — from automated provisioning to configuration management.",
      icon: <Terminal className="w-6 h-6" />,
    },
    {
      title: "Health Check & Reporting Automation",
      description: "Automate daily health checks, compliance audits, and performance reporting — replacing hours of manual verification with reliable, automated insights.",
      icon: <ClipboardCheck className="w-6 h-6" />,
    },
    {
      title: "Job Scheduling & Monitoring",
      description: "Optimise and monitor OS-level job scheduling (cron, systemd timers) — ensuring critical batch processes run reliably and on schedule.",
      icon: <Calendar className="w-6 h-6" />,
    },
  ];

  const tags = [
    "OS Performance", "Linux Tuning", "Automation", "Ansible", "Scripting", "Capacity Planning", "Batch Processing"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              OS performance that keeps pace with your business — and automation that eliminates the manual overhead.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Slow servers create slow applications, slow batches, and frustrated users. In high-volume financial operations, OS latency can lead to missed processing windows and increased operational risk.
                  </p>
                  <p>
                    Newel's OS Performance & Automation practice focuses on two goals: making your systems run at peak efficiency and ensuring they stay that way through robust automation. We eliminate the manual toil that slows down your operations team and your business.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Operational Velocity</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Efficiency First</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has tuned OS environments supporting high-throughput financial applications where every millisecond counts.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We don't just 'make it work' — we make it work at peak efficiency, and then we automate it so it stays that way."
                    </p>
                  </div>

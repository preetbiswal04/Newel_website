...
export default function StaffAugmentationPage() {
  const offerings = [
    {
      title: "Senior Technical Specialists",
      description: "Direct access to senior-level engineers, architects, and specialists who bring deep expertise in Cloud, AI, and enterprise infrastructure.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Sprint-Ready Integration",
      description: "Professionals who integrate seamlessly with your existing development workflows and sprint rhythms from day one.",
      icon: <Workflow className="w-6 h-6" />,
    },
    {
      title: "Cross-Functional Expertise",
      description: "Augment your team with a variety of roles including DevOps, Data Engineers, Full-Stack Developers, and QA Specialists.",
      icon: <Users className="w-6 h-6" />,
    },
    {
      title: "Rapid Resource Scaling",
      description: "Quickly scale your technical capacity to meet project deadlines or handle sudden increases in workload without long-term overhead.",
      icon: <Activity className="w-6 h-6" />,
    },
    {
      title: "Skill Gap Analysis & Sourcing",
      description: "We help identify the specific skill gaps within your team and source the exact expertise needed to overcome technical hurdles.",
      icon: <Search className="w-6 h-6" />,
    },
    {
      title: "Ongoing Performance Management",
      description: "We provide continuous support and management for our augmented staff to ensure they are consistently delivering value to your projects.",
      icon: <CheckCircle2 className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Staff Augmentation", "Resource Scaling", "Senior Engineers", "Team Integration", "Skill Gap Sourcing", "Agile Scaling"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Boost your team's velocity. Expert IT professionals who integrate seamlessly with your existing teams to accelerate delivery.
            </p>
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Beyond Augmenting: Seamless Team Integration
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Our professionals don't just work for you; they work with you. We specialize in providing senior-level engineers and specialists who understand your culture and sprint rhythm from day one.
                  </p>
                  <p>
                    We focus on high-velocity scaling, ensuring that our experts add value immediately and help your internal teams overcome technical bottlenecks and accelerate product roadmaps.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">High-Velocity Scaling</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Proven Scaling Partner</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has a long history of augmenting technical teams for some of the largest digital transformation projects in the region.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We don't just provide resources; we provide velocity. Our experts help you get to market faster with the highest technical standards."
                    </p>
                  </div>

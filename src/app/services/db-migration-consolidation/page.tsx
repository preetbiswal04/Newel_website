...
export default function DBMigrationConsolidationPage() {
  const offerings = [
    {
      title: "Oracle to PostgreSQL Migration",
      description: "Migrate Oracle databases to PostgreSQL using ora2pg and custom migration tooling — converting PL/SQL, stored procedures, and data types with validated application compatibility.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "Cross-Platform Database Migration",
      description: "Migrate between database platforms — Oracle, MSSQL, MySQL, PostgreSQL, MongoDB — with schema conversion, data migration, application testing, and cutover planning.",
      icon: <Share2 className="w-6 h-6" />,
    },
    {
      title: "Database Version Upgrades",
      description: "Plan and execute in-place or migration-based database version upgrades — minimising downtime, validating application compatibility, and ensuring post-upgrade performance.",
      icon: <ArrowUpCircle className="w-6 h-6" />,
    },
    {
      title: "Database Consolidation",
      description: "Consolidate multiple database instances onto fewer, properly sized servers — reducing licensing, infrastructure, and administration costs while simplifying your estate.",
      icon: <Layers className="w-6 h-6" />,
    },
    {
      title: "License Usage Analysis",
      description: "Analyse your current database licensing position — identifying unused features, over-licensed editions, and opportunities to right-size spend before migration.",
      icon: <PieChart className="w-6 h-6" />,
    },
    {
      title: "Cutover Planning & Execution",
      description: "Plan and execute database cutovers with minimal downtime — using parallel data loading and replication-based migration to protect business continuity.",
      icon: <Workflow className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Database Migration", "Oracle to PostgreSQL", "DB Consolidation", "License Optimisation", "Cross-Platform", "Zero Downtime"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/Migration-Consolidation.png')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Move your databases confidently — zero data loss, minimal downtime, and a clear path to lower cost.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Database migrations and consolidations are high-stakes projects — but they're also significant opportunities.
                  </p>
                  <p>
                    Newel has executed complex migrations for financial services clients with zero data loss and seamless application compatibility. Whether you're moving from Oracle to PostgreSQL to cut licensing costs or consolidating fragmented estates to reduce overhead, we provide a clear, risk-managed path.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  <img 
                    src="/Migration-Consolidation.png" 
                    alt="Database Migration Visual" 
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Transformation Strategy</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Proven Efficiency</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has delivered Oracle-to-PostgreSQL migrations with zero data loss and 35-50% licensing cost reduction.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We bring order to complexity — whether it's high-stakes migrations or consolidating fragmented estates across global environments."
                    </p>
                  </div>

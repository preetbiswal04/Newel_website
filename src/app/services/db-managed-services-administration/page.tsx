...
export default function DBManagedServicesPage() {
  const offerings = [
    {
      title: "24x7 Database Monitoring & Support",
      description: "Round-the-clock monitoring of all database environments with defined SLAs, alert-based incident response, and escalation procedures — minimising the impact of database issues on business operations.",
      icon: <Clock className="w-6 h-6" />,
    },
    {
      title: "Database Administration (DBA Services)",
      description: "Full DBA services across Oracle, MSSQL, PostgreSQL, MySQL, MongoDB, and Redis — covering user management, space management, object maintenance, and day-to-day operational support.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "Patch Management & Upgrades",
      description: "Systematic database patching — PSU/CPU application for Oracle, service pack updates for MSSQL, minor and major version upgrades — with change-controlled processes and rollback plans.",
      icon: <ArrowUpCircle className="w-6 h-6" />,
    },
    {
      title: "Backup & Recovery Management",
      description: "Implement, monitor, and validate database backup strategies — RMAN, SQL Server Agent, pg_dump — with tested recovery procedures and RPO-aligned retention policies.",
      icon: <ShieldCheck className="w-6 h-6" />,
    },
    {
      title: "Automation of Daily Operations",
      description: "Automate routine DBA tasks — health checks, space alerts, job monitoring, statistics gathering, log management — reducing manual effort and improving operational consistency.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Governance & Reporting",
      description: "Weekly database health reports and monthly steering committee reviews — covering availability, performance, incidents, capacity, and upcoming maintenance — for full operational visibility.",
      icon: <FileText className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Database Managed Services", "Oracle DBA", "MSSQL", "PostgreSQL", "MongoDB", "24x7 DBA", "Financial Services"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Mission-critical databases, expertly managed — so your data is always available, always performing, always protected.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    In financial services, data is the business. Every transaction, every loan, every customer record depends on a database that's available, accurate, and performing.
                  </p>
                  <p>
                    Newel's Database Managed Services practice provides expert administration for enterprise and open-source databases — Oracle, MSSQL, PostgreSQL, MySQL, MongoDB — with 24x7 coverage, proactive monitoring, and governance that satisfies audit and compliance requirements.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  <img 
                    src="/home-img-7.jpg" 
                    alt="Database Managed Services Visual" 
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">DBA Operations</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Operational Scale</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel manages 5+ data warehouse environments spanning Oracle, MSSQL, PostgreSQL, and MongoDB for financial services clients.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We deliver consistent SLA-backed administration with the rigour that audit-ready environments demand."
                    </p>
                  </div>

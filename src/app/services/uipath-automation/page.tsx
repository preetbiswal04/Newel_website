...
export default function UiPathAutomationPage() {
  const offerings = [
    {
      title: "Process Discovery & Automation Assessment",
      description: "We work with your operations teams to identify and prioritise automation candidates — evaluating process volume, complexity, stability, and ROI potential before writing a single bot.",
      icon: <Search className="w-6 h-6" />,
    },
    {
      title: "UiPath Bot Development",
      description: "Design and build attended and unattended UiPath bots for a wide range of financial operations — data entry, EOD/BOD processing, MIS reporting, reconciliation, and system integration.",
      icon: <Cpu className="w-6 h-6" />,
    },
    {
      title: "UiPath Orchestrator Setup & Management",
      description: "Deploy and manage UiPath Orchestrator for centralised bot scheduling, monitoring, exception handling, and audit trail management — giving you full governance over your automation estate.",
      icon: <Settings className="w-6 h-6" />,
    },
    {
      title: "Exception Handling & Alerting",
      description: "Build robust exception handling and alerting frameworks so that process failures are caught, logged, and escalated immediately — minimising operational risk.",
      icon: <Bell className="w-6 h-6" />,
    },
    {
      title: "Bot Maintenance & Enhancement",
      description: "Ongoing support and maintenance for deployed bots — handling application UI changes, process updates, and continuous performance optimisation.",
      icon: <Wrench className="w-6 h-6" />,
    },
    {
      title: "UiPath to Power Automate Migration",
      description: "For organisations looking to consolidate their automation stack, we manage structured migrations from UiPath to Microsoft Power Automate — preserving business logic while reducing licensing cost.",
      icon: <ArrowLeftRight className="w-6 h-6" />,
    },
  ];

  const tags = [
    "UiPath", "RPA", "Robotic Process Automation", "Bot Development", "Orchestrator", "Financial Services", "EOD Automation"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/UI-path-11.png')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Eliminate repetitive manual work with intelligent UiPath bots — faster processing, fewer errors, full auditability.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Manual processes are the hidden cost of every financial services operation. Data entry, reconciliation, report generation, EOD processing, loan validation — hours of human effort that are slow, error-prone, and hard to scale.
                  </p>
                  <p>
                    Newel's UiPath Automation practice designs, builds, and manages enterprise-grade RPA bots that take over these tasks — freeing your teams for higher-value work while improving accuracy, speed, and compliance.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  >
                    <source src="/UI-path-11-vd.mp4" type="video/mp4" />
                  </video>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Bot Engineering</span>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has delivered 25+ RPA projects for financial services clients.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We combine UiPath technical expertise with deep domain knowledge of NBFC and broking operations."
                    </p>
                  </div>

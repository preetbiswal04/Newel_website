  ...
  const offerings = [
    {
      ...
      description: "Build models that forecast outcomes — loan defaults, customer churn, repayment behaviour, equipment failure, demand patterns — giving your teams the foresight to act proactively.",
      icon: <TrendingUp className="w-6 h-6" />,
    },
    {
      title: "Classification & Clustering",
      description: "Automate categorisation tasks and discover natural groupings in your data — from customer segmentation to transaction classification and anomaly grouping.",
      icon: <Layers className="w-6 h-6" />,
    },
    {
      title: "Anomaly & Fraud Detection",
      description: "Deploy ML models that identify unusual patterns in transactions, user behaviour, or operational data in real time — reducing risk and enabling faster response.",
      icon: <ShieldAlert className="w-6 h-6" />,
    },
    {
      title: "NLP & Text Analytics",
      description: "Extract meaning from unstructured text — customer complaints, call transcripts, emails, contracts — using natural language processing models trained on your domain data.",
      icon: <FileText className="w-6 h-6" />,
    },
    {
      title: "Model Deployment & MLOps",
      description: "We don't just build models — we deploy them. We set up CI/CD pipelines for ML, containerised model serving, monitoring dashboards, and automated retraining workflows.",
      icon: <Box className="w-6 h-6" />,
    },
    {
      title: "Model Explainability & Governance",
      description: "For regulated environments, explainability is non-negotiable. We build models with interpretability in mind and implement frameworks for model documentation, version control, and audit trails.",
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/machine-learning-11.png')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            >
              ...
              Purpose-Built ML for Business Impact
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Purpose-built ML models that solve real business problems — not experiments that never leave the notebook.
            </p>
            ...
            >
              {[
                ...
                { value: "70%", label: "Faster Workflows" },
                { value: "1M+", label: "Monthly Inferences" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Machine learning works when it's grounded in a clear problem, clean data, and a path to production. 
                    Newel builds end-to-end ML solutions — from problem framing and data preparation through to model deployment, monitoring, and continuous improvement.
                  </p>
                  <p>
                    Our focus is always on business impact: models that are accurate, explainable, and maintained reliably in production environments.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  <video
                    src="/machine-learning-vd-11.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-br from-white/[0.05] to-transparent p-12 md:p-20 rounded-[40px] border border-white/10 backdrop-blur-sm">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-cyan-400 font-black text-xs uppercase tracking-[0.3em]">The Newel Edge</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-white/90 leading-snug">
                    Newel has deployed ML models in production for QRC classification, risk scoring, and compliance analytics across financial institutions.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-white/60 italic leading-relaxed">
                      "We've seen what makes models succeed in regulated, high-stakes environments — and we build accordingly."
                    </p>
                  </div>
               </div>
            </div>

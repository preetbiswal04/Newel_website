...
import { PhoneCall, Sparkles, ShieldCheck, Activity, Smartphone, CheckSquare } from "lucide-react";
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/70 font-medium leading-relaxed max-w-2xl">
              Users don't have the patience for software that glitches or loads slowly. Quality Assurance is indispensable to ensure your software works flawlessly every single time.
            </p>
              ...
              <div className="lg:w-1/2 p-10 md:p-14 flex flex-col justify-center space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-white/60 text-base md:text-lg leading-relaxed font-medium">
                    We practice DevOps, CI/CD, agile testing, and test automation for web, desktop, mobile, legacy applications, and APIs to guarantee flawless execution.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { icon: <CheckSquare size={20} />, text: "Functional Testing" },
                    { icon: <Smartphone size={20} />, text: "Compatibility Testing" },
                    { icon: <Activity size={20} />, text: "Performance Testing" },
                    { icon: <ShieldCheck size={20} />, text: "Regression Testing" },
                  ].map((item) => (
                    <div
                      key={item.text}

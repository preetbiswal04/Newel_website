  ...
  const offerings = [
    {
      ...
      description: "Evaluate your applications, data, infrastructure, and operating model for cloud suitability — identifying migration candidates, dependencies, risks, and estimated effort.",
      icon: <Search className="w-6 h-6" />,
    },
    {
      title: "Cloud Strategy & Architecture Design",
      description: "Define your target cloud architecture — hybrid, multi-cloud, or cloud-native — with security, governance, cost optimisation, and regulatory alignment built in from the start.",
      icon: <Layout className="w-6 h-6" />,
    },
    {
      title: "Migration Planning & Execution",
      description: "Structured migration execution across all workload types: rehost, replatform, refactor, or retire — with wave planning, dependency mapping, and rollback strategies.",
      icon: <Send className="w-6 h-6" />,
    },
    {
      title: "On-Prem to Cloud Migration",
      description: "Migrate applications, databases, and workloads from on-premise infrastructure to AWS, Azure, GCP, or OCI — with minimal downtime and validated performance.",
      icon: <Cloud className="w-6 h-6" />,
    },
    {
      title: "Cloud to Cloud Migration",
      description: "Move workloads between cloud providers with architecture re-optimisation — ensuring you take advantage of the target cloud's native capabilities.",
      icon: <ArrowLeftRight className="w-6 h-6" />,
    },
    {
      title: "DR to Cloud Implementation",
      description: "Implement cloud-based disaster recovery strategies that meet your RTO and RPO requirements — giving you business continuity without secondary data centre costs.",
      icon: <Shield className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Cloud Strategy", "Cloud Migration", "AWS", "Azure", "GCP", "OCI", "Hybrid Cloud", "DR", "Financial Services"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/Cloud-Strategy-Migration-img.jpeg')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              We don't push cloud for experimentation. Cloud adoption aligned to your regulatory posture, security requirements, and business continuity needs.
            </p>
            ...
            >
              {[
                ...
                { value: "AWS", label: "Expert Partner" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Cloud migration is not a lift-and-shift exercise — it's a business transformation. Done well, it delivers flexibility, cost efficiency, and competitive agility. Done poorly, it creates complexity, risk, and cost overruns.
                  </p>
                  <p>
                    Newel's Cloud Strategy & Migration practice takes a governed, phased approach — assessing your current state, defining the right cloud architecture, and executing migration with minimal downtime and zero compromise on security or compliance.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  >
                    <source src="/Cloud-Strategy-Migration-vd.mp4" type="video/mp4" />
                  </video>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Migration Engineering</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Proven Experience</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has executed cloud migrations for financial services clients — including full AWS cloud-native re-architecture.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We understand the regulatory and compliance sensitivities of moving financial workloads to the cloud."
                    </p>
                  </div>

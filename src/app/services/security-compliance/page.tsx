  ...
  const offerings = [
    {
      ...
      description: "Continuously monitor your cloud environment for misconfigurations and security risks — enforcing best practices across all your accounts and regions.",
      icon: <Shield className="w-6 h-6" />,
    },
    {
      title: "Identity & Access Management (IAM) Governance",
      description: "Design and implement principle of least privilege — managing users, roles, and permissions across complex multi-account cloud environments.",
      icon: <UserCheck className="w-6 h-6" />,
    },
    {
      title: "Infrastructure & Data Encryption",
      description: "Implement robust encryption for data at rest and in transit — managing KMS keys and certificates to ensure your data remains protected.",
      icon: <Lock className="w-6 h-6" />,
    },
    {
      title: "Regulatory Alignment",
      description: "Map technical cloud controls to SOC2, ISO27001, and local financial regulations — ensuring your cloud environment is audit-ready at all times.",
      icon: <CheckCircle className="w-6 h-6" />,
    },
    {
      title: "Vulnerability Management & Patching",
      description: "Automate vulnerability scanning and patching for your cloud instances and containers — maintaining a hardened environment with minimal manual effort.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Security Logging & Monitoring",
      description: "Centralise and monitor security logs across your cloud footprint — enabling rapid detection and response to potential security incidents.",
      icon: <Eye className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Cloud Security", "Compliance", "IAM", "Encryption", "SOC2", "ISO27001", "Regulatory Alignment", "Financial Services"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/compliance-img.png')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Move to the cloud without compromising your regulatory posture or data security.
            </p>
            ...
            >
              {[
                { value: "Zero", label: "Breach Incident" },
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    In financial services, security isn't a feature — it's a foundation. The challenge of cloud adoption is often less about technology and more about maintaining control, auditability, and compliance in a shared responsibility model.
                  </p>
                  <p>
                    Newel's Security & Compliance practice helps organisations build fortified cloud environments that satisfy the most stringent regulatory requirements — without losing the speed and agility of the cloud.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  >
                    <source src="/compliance-vd.mp4" type="video/mp4" />
                  </video>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Governance & Risk Management</span>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has designed and implemented cloud security frameworks for regulated financial institutions.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We understand how to map technical cloud controls to enterprise risk requirements — ensuring a secure, audit-ready posture."
                    </p>
                  </div>

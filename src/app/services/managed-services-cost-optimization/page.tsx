...
export default function ManagedServicesPage() {
  const offerings = [
    {
      title: "24x7 Cloud Monitoring & Incident Management",
      description: "Round-the-clock monitoring of your cloud infrastructure with defined SLAs, escalation paths, and rapid incident response — ensuring uptime across all accounts.",
      icon: <Clock className="w-6 h-6" />,
    },
    {
      title: "Cost Optimisation & FinOps",
      description: "Identify and eliminate wasteful spend — rightsizing instances, implementing Savings Plans, removing idle resources, and enforcing tagging for cost attribution.",
      icon: <BarChart3 className="w-6 h-6" />,
    },
    {
      title: "Resource & Capacity Management",
      description: "Continuously manage capacity across your cloud accounts — ensuring you have what you need, without paying for what you don't.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Security & Compliance Management",
      description: "Monitor and enforce cloud security posture — IAM governance, security group management, patch compliance, and regulatory alignment.",
      icon: <ShieldCheck className="w-6 h-6" />,
    },
    {
      title: "Multi-Account Management",
      description: "Manage complex multi-account AWS or Azure environments with centralised governance, visibility, and control — covering 27+ accounts.",
      icon: <Layers className="w-6 h-6" />,
    },
    {
      title: "Governance Reporting",
      description: "Weekly operational status reports and monthly steering committee reviews — giving leadership full visibility into cloud health, spend, and incidents.",
      icon: <FileText className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Cloud Managed Services", "AWS", "Cost Optimisation", "FinOps", "Multi-Account", "24x7 Support", "Governance"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Your cloud, running at its best — continuously managed, governed, and optimised for performance and cost.
            </p>
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Running Well is the Real Challenge
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Getting to the cloud is one challenge. Running it well is another. Without ongoing management, cloud environments drift — costs escalate, resources sprawl, security gaps appear, and performance degrades.
                  </p>
                  <p>
                    Newel's Cloud Managed Services practice takes ownership of your cloud operations — monitoring, managing, and continuously optimising your environment so your internal teams can focus on business priorities.
                  </p>
                </div>
             </motion.div>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Operations & FinOps</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Scale & Efficiency</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel manages 27 AWS accounts and 1,000+ Lambda functions for a large financial services group.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We deliver over 20% cost savings while maintaining full performance and reliability for mission-critical stacks."
                    </p>
                  </div>

...
export default function MWHighAvailabilityPage() {
  const offerings = [
    {
      title: "Middleware Clustering & HA Configuration",
      description: "Design and implement clustered middleware environments — WebLogic clusters, WebSphere ND cells, JBoss domain mode — with session replication, load balancing, and automatic failover.",
      icon: <Layers className="w-6 h-6" />,
    },
    {
      title: "Load Balancer Integration",
      description: "Configure and manage load balancers (hardware and software) integrated with middleware clusters — ensuring traffic distribution, health checking, and seamless failover.",
      icon: <Network className="w-6 h-6" />,
    },
    {
      title: "JVM Tuning for High Availability",
      description: "Tune JVM settings — heap sizing, garbage collection configuration, thread pool sizing — to ensure stable performance under load and minimise GC-related availability impacts.",
      icon: <Cpu className="w-6 h-6" />,
    },
    {
      title: "DR Architecture Design",
      description: "Design middleware DR architectures aligned to your RTO/RPO requirements — active-passive or active-active configurations with defined failover procedures.",
      icon: <Workflow className="w-6 h-6" />,
    },
    {
      title: "Backup & Recovery Procedures",
      description: "Implement and test middleware backup procedures — domain configuration, deployment archives, security stores, and SSL certificates — with validated recovery procedures and runbooks.",
      icon: <ShieldCheck className="w-6 h-6" />,
    },
    {
      title: "DR Testing & Failover Validation",
      description: "Conduct regular DR drills for middleware components — validating failover procedures, measuring recovery times, and updating documentation to reflect current architecture.",
      icon: <RotateCcw className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Middleware HA", "WebLogic Cluster", "WebSphere", "JBoss", "Load Balancer", "JVM Tuning", "DR", "High Availability"
  ];
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Middleware that doesn't become a single point of failure — designed for resilience, tested for recovery.
            </p>
            ...
            >
              {[
                { value: "Zero", label: "Single Points" },
                { value: "Active", label: "Resilience" },
                { value: "100%", label: "Tested Failover" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    High availability in middleware is often overlooked — attention goes to databases and applications while middleware is left as a potential single point of failure.
                  </p>
                  <p>
                    Newel designs and implements HA and DR architectures for your middleware layer — ensuring that WebLogic clusters, WebSphere cells, JBoss domains, and load balancers are as resilient as the applications they serve.
                  </p>
                </div>
             </motion.div>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Critical Continuity</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel manages middleware HA for financial services applications where transaction continuity and session persistence are critical.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "We design resilience into every layer of the stack to protect your most critical application flows."
                    </p>
                  </div>

...
export default function MicrosoftOnAWSPage() {
  const offerings = [
    {
      title: "SQL Server on AWS (RDS / EC2)",
      description: "Migrate and manage SQL Server workloads on AWS — using RDS for managed database services or EC2 for full control — with HA, DR, and performance optimisation.",
      icon: <Database className="w-6 h-6" />,
    },
    {
      title: "Windows Server on AWS",
      description: "Migrate and operate Windows Server environments on AWS EC2 — including Active Directory, IIS, and application servers — with security hardening and patch management.",
      icon: <Server className="w-6 h-6" />,
    },
    {
      title: ".NET Application Migration to AWS",
      description: "Rehost or replatform .NET applications to AWS — migrating from on-premise IIS environments to Elastic Beanstalk, ECS, or EC2-based deployments.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Licensing Optimisation",
      description: "Leverage AWS Licence Mobility, Dedicated Hosts, and BYOL options to reduce Microsoft licensing costs while maintaining compliance with licensing terms.",
      icon: <CheckCircle className="w-6 h-6" />,
    },
    {
      title: "AWS Managed Active Directory",
      description: "Deploy and manage AWS Directory Service for Microsoft Active Directory — enabling SSO, Group Policy, and domain-joined instances without on-premise dependency.",
      icon: <Shield className="w-6 h-6" />,
    },
    {
      title: "Hybrid Connectivity",
      description: "Design and implement hybrid connectivity between your on-premise Microsoft environment and AWS — using Direct Connect or VPN for secure, low-latency integration.",
      icon: <Workflow className="w-6 h-6" />,
    },
  ];

  const tags = [
    "Microsoft on AWS", "SQL Server", "Windows Server", ".NET", "Active Directory", "AWS", "Licensing Optimisation"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#E5E7EB] selection:bg-blue-500/30 selection:text-blue-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/Microsoft-Workloads-AWS.png')",
        ...
        <div className="relative z-10 container-page mx-auto py-32 flex w-full justify-end">
          ...
          >
            ...
            >
              ...
              Enterprise Microsoft Optimization
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Run your Microsoft workloads on AWS — with the performance, licensing efficiency, and support you need.
            </p>
            ...
            >
              {[
                ...
                { value: "45%", label: "TCO Reduction" },
                { value: "100%", label: "Licensing Compliant" },
              ].map((stat) => (
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">
                    Optimized Microsoft Hosting
                  </h2>
                </div>
                <div className="space-y-6 text-white/70 text-lg leading-relaxed font-medium">
                  <p>
                    Many organisations run critical Microsoft workloads — SQL Server, Windows Server, Active Directory, .NET applications — that are now best hosted on AWS. AWS offers significant licensing advantages, flexible deployment options, and enterprise-grade infrastructure.
                  </p>
                  <p>
                    Newel helps organisations plan, migrate, and operate Microsoft workloads on AWS — capturing cost savings and cloud benefits without disrupting the applications your business depends on.
                  </p>
                </div>
             </motion.div>
             ...
             >
                <div className="relative rounded-3xl overflow-hidden aspect-video border border-white/10 group">
                  ...
                  >
                    <source src="/Microsoft-Workloads-AWS-vd.mp4" type="video/mp4" />
                  </video>
      ...
      <section className="bg-[#E5E7EB] py-32 relative overflow-hidden border-t border-slate-200">
        <div className="container-page mx-auto relative z-10">
          <div className="text-center mb-20 space-y-4">
            <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Cloud Migration Engineering</span>
          ...
          <div className="max-w-5xl mx-auto bg-white p-12 md:p-20 rounded-[40px] border border-slate-200 shadow-xl shadow-blue-900/5">
            <div className="flex flex-col md:flex-row gap-12 items-start">
               <div className="md:w-1/3">
                  <div className="space-y-4">
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.3em]">Deep Expertise</span>
               ...
               <div className="md:w-2/3 space-y-8">
                  <p className="text-2xl font-medium text-slate-800 leading-snug">
                    Newel has managed Microsoft technology stacks for financial services clients for over 10 years.
                  </p>
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-slate-500 italic leading-relaxed">
                      "Across SQL Server, Windows OS, IIS, and Active Directory — we bring decade-long experience to AWS migrations and operations."
                    </p>
                  </div>
